...
def make_input_dataframe_by_entity(tax_benefit_system, nb_persons, nb_groups):
    ...
    Returns:
      ...
      Example:
        ...
        >>> from tests.input_dataframe_generator import make_input_dataframe_by_entity
...
def set_table_in_survey(
    ...
    try:
        ...
        fallback_dir = Path(openfisca_data_manager_location) / "openfisca_data_manager" / "tests" / "data_files"
