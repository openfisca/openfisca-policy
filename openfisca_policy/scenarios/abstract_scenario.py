...
from openfisca_data_manager.core.survey import Survey
from openfisca_data_manager.exceptions import SurveyManagerError

from openfisca_policy import Simulation
from openfisca_policy.calibration import Calibration
...
class AbstractSurveyScenario:
    ...
    def summarize_variable(
        ...
        Example (output is sent to the logging system at INFO level):
            >>> from tests.test_scenario import create_randomly_initialized_survey_scenario
