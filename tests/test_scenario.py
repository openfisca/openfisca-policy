...
from openfisca_policy.scenarios.abstract_scenario import AbstractSurveyScenario
from openfisca_policy.scenarios.reform_scenario import ReformScenario
from tests import tax_benefit_system
from tests.input_dataframe_generator import (
...
def create_randomly_initialized_survey_scenario(
    ...
    if config_files_directory is None:
        config_files_directory = Path(tempfile.mkdtemp(prefix="openfisca-policy-tests-"))
